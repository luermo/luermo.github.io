...
<section class="section projects" id="proyectos">
    <div class="container">
        ...
        <p class="text-center">Esta es una pequeña muestra de los últimos proyectos que he desarrollado</p>
        <div class="row project-list">
            <ul class="project-grid project-effect-shrink">
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/instop.jpg" alt="instop"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">instop</h3>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/fraikin.jpg" alt="fraikin"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">fraikin</h3>
                                <!--                                <p>Sistema de gestión documental</p>-->
                                <a href="http://goomedical.es/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/todoirabien.jpg" alt="#TodoIráBien"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">#TodoIráBien</h3>
                                <!--                                <p>Sistema de gestión documental</p>-->
                                <a href="http://goomedical.es/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/mba.jpg" alt="MBA"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">MBA</h3>
                                <!--                                <p>Sistema de gestión documental</p>-->
                                <a href="http://goomedical.es/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/gregoriomaranon.jpg" alt="gregorio marañon"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">Gregorio Marañon</h3>
                                <!--                                <p>Sistema de gestión documental</p>-->
                                <a href="http://goomedical.es/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/falk.jpg" alt="Falk vl"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">Falk V.L.</h3>
                                <p></p>
                    ...
                    <figure>
                        ...
                        <figcaption>
                            <div class="project-item-info">
                                ...
                                <p>Aplicación para congresos, eventos y confererncias</p>
                                <a href="http://getsmartConf.com/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                    </figure>
                </li>
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/BBM.jpg" alt="bbm"/>
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">BBM barcelona breast meeting</h3>
                                <p>Aplicación multiplataforma para un congreso especifico sobre medicina</p>
                                <a href="http://bbm.cat/" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                    </figure>
                </li>
                ...
                <li class="col-md-6">
                    <figure>
                        <img src="../assets/img/projects/visitum.png" alt="visitum"/>
                        <figcaption>
                            <div class="project-item-info">
                ...
                <li class="col-md-6">
                    <figure>
                        ...
                        <figcaption>
                            <div class="project-item-info">
                                <h3 class="sub-heading">Indra bmb - Gestión documental</h3>
                                <p>Sistema de gestión documental</p>
                                <a href="http://www.indracompany.com/en/soluciones-y-servicios/solucion/document-management/1620/summary" target="_blank" class="btn btn-default">Visitar proyecto</a>
                            </div>
                        </figcaption>
                    </figure>
                </li>
