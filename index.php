...
<html lang="es">
    <head>
        ...
        <!-- facebookmetas -->
        <meta property="og:title" content="Programador Freelance para emprenededores y Startups">
        <meta property="og:description" content="Hola, soy Eric, ubicado en Barcelona ofrezco programación freelance para emprendedores y Startups aplicando metodologías Lean y Agile">
            ...
            <div class="container">
                ...
                <div class="row interest">
                    <div class="col-md-3">
                        ...
                        <p>Estructuraremos iteraciones <strong>semanales</strong> donde entregaré una versión de la <strong>aplicación funcional (sin errores)</strong> y tomaré requisitos para priorizar las funcionalidades que a la vez fijamos a desarrollar durante la siguiente semana.</p>
                    </div>
                    <div class="col-md-3">
                        <h3 class="sub-heading"><span class="glyphicon glyphicon-globe"></span> Programación escalable</h3>
                        <p>Con unas bases sólidas, de manera continua iremos escalando la aplicación, idea y negocio. Llegando a mucho más clientes y usuarios.</p>
                    </div>
                    <div class="col-md-3">
