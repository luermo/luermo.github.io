...
<head>
    ...
    <meta name="keywords"
          content="programador,freelance ,programación ,web , agile, lean, barcelona, Diseño, Marketing online, aplicaciones, Web, Movile, Apps, ios, android,aplicaciones nativas, barcelona y alrededores, bootstrap, php, symfony2, jquery">
        ...
        <div class="container">
            ...
            <div class="row interest">
                <div class="col-md-3">
                    ...
                    <p>Estructuraremos iteraciones <strong>semanales</strong> donde entregaré una versión de la <strong>aplicación funcional (sin errores)</strong> y tomaré requisitos para priorizar las funcionalidades que a la vez fijamos a
                        desarrollar durante la siguiente semana.</p>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <p>Me gusta conocer <strong>Empresas</strong> y <strong>Startups </strong> con buenas ideas o proyectos donde podamos compartir conocimientos y aprender. Así que si te parece bien contacta conmigo y te explicaré cómo puedo
                        ayudarte.</p>
                </div>
            </div>
            <!--<div class="social">
